...
<div class="container">
     ...
     <div>
          ...
          <!-- Shellcode Challenge 1 -->
          <div id="SCChal1Modal" class="modal">
               <!-- Modal content -->
               <div class="modal-content">
                    <span class="close" id="span1" onclick = "closeWithSpan(document.getElementById('SCChal1Modal'))" style="color:#FFFFFF;">&times;</span>
                    <div class="row">
                         <div class="col-lg-12">
                              <h3><u><b>Challenge 1 (Polymorphic Shellcode) : 50pts</b></u></h3>
                              <br>
                              ...
                              <a href="https://drive.google.com/open?id=0BwRJUP-ZgBwsQ2xNVWMxdVN0QlU">Binary File</a>
                              <form action="checkFlag.php" method="post" name="chal1">
                                   <label for="sc1_flag">Enter Flag:</label>
                                   <input id="sc1_flag" class="chals" type="text" name="flag" required />
                                   <input type="submit" name="chal_flag" value="shell1" />
                              </form>
                         </div>
                    </div>
               </div>
     ...
     <!-- End Shellcode Modals -->
     <!-- Shellcode Challenge Buttons -->
     <div id="ShellcodeChallengeButtons">
          <li><button id="SCChal1Btn" onclick="openModal(document.getElementById('SCChal1Modal'))">Challenge 1 (Polymorphic Shellcode) : 50pts</button></li>
     </div>
     <!-- End Shellcode Challenge Buttons -->
     <br>
