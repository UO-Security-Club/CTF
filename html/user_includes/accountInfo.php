...
$welcome = "<li class='nav'><a href='welcome.php'>Home</a></li>";
$scores = "<li class='nav'><a href='scores.php'>Scores</a></li>";
$challenges = "<li class='nav'><a href='challenges.php'>Challenges</a></li>";
