...
<div class="container">
     ...
     <!-- Crypto Modals -->     
     <div>
          Unless otherwise specified, flag format is UOSEC_[*****] with the deciphered message in uppercase, between the brackets.
          <!-- Crypto Challenge 1 -->
               ...
               <div class="modal-content">
                    ...
                    <div class="row">
                         <div class="col-lg-12">
                              ...
                              <br>
                              <p><u>Description:</u> You need math for this one! ...barely.</p>
     ...
     <div>
          ...
          <div id="StegChal3Modal" class="modal">
               <!-- Modal content -->
               <div class="modal-content">
                    <span class="close" id="span1" onclick="closeWithSpan(document.getElementById('StegChal1Moda3'))" style="color:#FFFFFF;">&times;</span>
                    <div class="row">
                         <div class="col-lg-12">
                              <h3><b><u>Challenge 3: 5pts</u></b></h3>
                              <br>
                              <p><u>Description:</u> Cats have magic abilities.</p>
                              <p><img src= "images/steg3.jpg" /></p>
                              <form action="checkFlag.php" method="post" name="chalN">
                                   <label for="chalN_flag">Enter Flag:</label>
                                   <input id="chalN_flag" class="chals" type="text" name="flag" required />
     ...
     <button id="WebChal1Btn" onclick="openModal(document.getElementById('WebChal1Modal'))">Challenge 1 (Basic Burp Suite / Poor Data Validation) : 10pts</button>
